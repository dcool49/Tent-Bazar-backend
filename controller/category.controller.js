...
exports.update =(req,res,next)=>{
 ...
 if(req.body._id && req.files && req.files.files && req.body.categoryName)
    {
        ...
        if (!Array.isArray(files)) { 
          ...
          .then((result)=>{
            ...
            if(result.length==1)
            {
             ...
             Category.findByIdAndUpdate({_id:req.body._id},{$set:{image:result,categoryName:req.body.categoryName}})
             .then((updateresult) =>{
                response.status=true;
